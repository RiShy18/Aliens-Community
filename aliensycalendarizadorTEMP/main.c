...
void *alienGen(void *arguments){/*
    llist *mylist = ((struct argsGen *)arguments)->mylist;
    double interval = ((struct argsGen *)arguments)->interval;
    int total = ((struct argsGen *)arguments)->total;
    int velocidad = ((struct argsGen *)arguments)->velocidad;
    pthread_mutex_t *lockColonia = ((struct argsGen *)arguments)->lockColonia;
    int *generating = &((struct argsGen *)arguments)->generating;*/
