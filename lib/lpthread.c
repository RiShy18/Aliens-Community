 ...
 *
*/
int Lthread_create( void * (*funcPtr)(void*), void* args) {
	interruptDisable();
	//Create a new thread
	int id = ++maxID;
 ...
 *
*/
void Lthread_join(int id, void** res) {
	interruptDisable();
 ...
 *
*/
void Lmutex_trylock(int lockNum) {
        interruptDisable();
 ...
 *
*/
void Lmutex_unlock(int lockNum) {
	interruptDisable();
	//Make sure the lock is valid
	if (0 <= lockNum && lockNum < NUM_LOCKS) {
		//Unlock it
